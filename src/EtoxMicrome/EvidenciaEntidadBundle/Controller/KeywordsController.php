...
class KeywordsController extends Controller
{
    ...
    {
        $alert="LLega al EvidenciaEntidadBundle:Keywords:index";
        if (null == $keyword) {
            $keyword = $this->container->getParameter('etoxMicrome.keyword_por_defecto');
            return new RedirectResponse($this->generateUrl('list_keywords', array('keyword' => $keyword)));
        }
        ...
        //Tenemos que recuperar todas las evidencias cuyo texto contenga la keyword en particular. Obviamente el campo Evidencia.texto debe estar indexado. Mirar en la entidad
