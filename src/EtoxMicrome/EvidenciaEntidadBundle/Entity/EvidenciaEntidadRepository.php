...
class EvidenciaEntidadRepository extends EntityRepository
{
    ...
    public function findEvidenciaEntidadFromId($evidenciaEntidad_id)
    {
        $alert="para aqui";
        ...
        $consulta = $em->createQuery('
            ...
            WHERE e.id = :evidenciaEntidad_id
        ');
        $consulta->setParameter('evidenciaEntidad_id', $evidenciaEntidad_id);
        $evidenciaEntidad=$consulta->getSingleResult();
        ld($evidenciaEntidad);
        //ld($evidenciaEntidad->getId());
        //ld($evidenciaEntidad->getEntidad());
        //ldd($evidenciaEntidad->getEvidencia());
    ...
    public function queryEvidenciasParaEntidad($entidad)
    {
        ...
        $selectSQL="SELECT ee.evidencia_id FROM EvidenciaEntidad as ee INNER JOIN Evidencia ev ON ee.evidencia_id = ev.id  where ee.entidad_id=$entidad order by ev.score desc";
        //ld($selectSQL);
