...
class CompuestoController extends Controller
{
     ...
     * @Template()
     */
    public function showAction($id_compuesto, $id)
    {
        $em = $this->getDoctrine()->getManager();
     ...
     * @Template()
     */
     public function editAction($id_compuesto, $id)
    {
        $entidad=$id_compuesto;
        $em = $this->getDoctrine()->getManager();
        ...
        //Creamos tres arrays. neverCurated, onceCurated, twiceCurated que tienen las evidencias con 0, 1 y 2 curaciones de este compuesto
        //El $neverCuratedArray contiene en [0] un array con los primeros 30 ids de las evidencias de ese compuesto que no han sido curadas todavía y en [1] el número total sin curar. Pasamos a la vista el $neverCuratedArray.
     ...
     *
     */
    public function updateAction(Request $request, $id_compuesto, $id)
    {
        $alert="llegamos aqui, little by little";
        ...
        if ($this->getRequest()->getMethod() == 'POST') {
            ...
            if ($editForm->isValid()) {
                ...
                $em->flush();
                return $this->redirect($this->generateUrl('evidencia_compuesto_edit', array('id_compuesto' => $id_compuesto, 'id' => $id)));
            }
