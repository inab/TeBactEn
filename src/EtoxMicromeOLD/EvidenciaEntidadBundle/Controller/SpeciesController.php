...
class SpeciesController extends Controller
{
    ...
    public function indexAction($id_organismo)
    {
        ...
        $evidenciasEntidades = $paginador->paginate(
            $em->getRepository('EvidenciaEntidadBundle:EvidenciaEntidad')->queryEvidenciasParaOrganismo($entidad)
        )->getResult();
        ...
        #$autocompleteSpeciesForm = $this->createForm(new AutocompleteSpeciesType());
        #ldd($autocompleteSpeciesForm);
        return $this->render(
